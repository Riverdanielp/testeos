...
if ($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    function calcular_int_frances($valor,$cantidad,$cuota){
        // C = V * ( ((1+i)^N) * i ) / ( ((1+i)^N) - 1 ) //
        /////////////////////////////////////////////////// 
        //                    (1+i)^N * i                //
        //          C = V * _______________              //
        ...
        ///////////////////////////////////////////////////
        //
        //      0.1 * (1+i)^12 - 1 = (1+i)^12 * i
        //
        //
        ///////////////////////////////////////////////////
        //
        //      0.1 * (1+i)^12 * i = (1+i)^12 - 1
        //
        //
        ///////////////////////////////////////////////////
        //
    ...
    echo 'En Cantidad de Cuotas: ' . $cantidad . "<br/>\n";
    //echo 'Tasa de Interes: ' . $tasa_int . "<br/>\n";
    //echo '<br>';

    echo '</p>';
    echo '<p style="text-align: center; margin-left: auto; margin-right: auto;">';
    echo 'La cuota definida es: ' . number_format($cuota);
    echo 'La tasa de interés es: ' . number_format($cuota);
